        ...
        <div className="bg-card rounded-2xl border border-text/10 overflow-hidden mb-12">
            ...
            >
                <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-[17px] font-bold text-text">포인트 산정 기준</h3>
                </div>
                    ...
                    <div className="flex flex-wrap gap-2 mb-8">
                        {tabs.map((tab) => (
                            <button
                                ...
                                className={`px-5 py-2.5 rounded-xl text-[13px] font-black flex items-center gap-2 transition-all ${activeTab === tab.id
                            ...
                            {current.items.map((item: any, idx: number) => (
                                <div key={idx} className="p-5 px-8 flex items-center justify-between">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            <p className="text-[15px] font-black text-text/80">{item.title}</p>
                                            <p className="text-[12px] font-semibold text-text/30">{item.desc}</p>
                                        </div>
                                    </div>
